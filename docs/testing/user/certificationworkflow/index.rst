...
.. (c) OPNFV, Intel Corporation, Ericsson AB, Huawei
...
program, please contact the C&C committee by email to cvp@opnfv.org. This shall be
the email address for all communication with the CVP.

[Editor's note: the email address cvp@opnfv.org is a placeholder and will be
replaced once the actual email account is established for this purpose.]
...
The application form shall include the following information:
  ...
  - If the test is to be conducted by a third-party lab, please specify
    name and contact information of the third-party lab.
...
sent to the primary contact with confirmation and next step information.
...
By default, the results are visible only to the user who uploaded the data.
...
Notify via the official CVP email address that a review request has been made and reference
...
the test results or by affiliated organizations should not be part of the reviewers.

The primary contact may be asked via email for any missing information or
clarification of the application. The reviewers will make a determination and recommend to
