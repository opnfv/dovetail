...
- `CNTT Reference Implementation RI1 <https://github.com/cntt-n/CNTT/tree/Baldy/doc/ref_impl/cntt-ri>`_
- `CNTT Reference Conformance RC1 <https://github.com/cntt-n/CNTT/tree/Baldy/doc/ref_cert/lfn>`_
- `CNTT RC1 playbook <https://github.com/cntt-n/CNTT/blob/Baldy/doc/ref_cert/lfn/chapters/chapter04.md>`_
...
- `Setting Up ONAP <https://docs.onap.org/en/frankfurt/guides/onap-operator/settingup/index.html>`_
- `ONAP VNF Test Specifications <https://docs.onap.org/en/frankfurt/guides/onap-provider/index.html>`_
- `ONAP VNF Validation Documentation <https://docs.onap.org/en/latest/guides/onap-provider/vnfvalidator.html>`_

Note, for OVP2020.r1, all VNF requirements are in reference to the ONAP Frankfurt release (6.0.0).
