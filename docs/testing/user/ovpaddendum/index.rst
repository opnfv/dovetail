...
proprietary add-on features. This results in incompatibilities with Nova
Tempest API tests which fail due to unexpected data in API responses. In order
to resolve this transparently in the context of OVP, a temporary exemption
process has been created. More information on the exemption can be found in
section :ref:`dovetail-exemption_process_api_response_validation`.
