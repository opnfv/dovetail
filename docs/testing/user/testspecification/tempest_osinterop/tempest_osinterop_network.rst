...
* Test action 1: Create a subnetpool SNP1 with a specific name and get the name from the response
* **Test assertion 1:** The name get from the response is the same as the name used to create SNP1
* Test action 2: Show SNP1 and get the name from the response
* **Test assertion 2:** The name get from the response is the same as the name used to create SNP1
* Test action 3: Update the name of SNP1 and get the new name from the response
* **Test assertion 3:** The name get from the response is the same as the name used to update SNP1
* Test action 4: Update the name of SNP1 and get the new name from the response
* **Test assertion 4:** The name get from the response is the same as the name used to update SNP1
* Test action 5: Delete SNP1
...
* Subnetpools can be created, list, updated, shown and deleted.
