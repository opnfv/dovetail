...
* Subnets can be created successfully by setting different args.
...
* Networks/subnets/ports can be listed with their ids and other args.
...
* **Test assertion 1:** SG1 in in the list, the name and description of SG1 equal to the ones used to
...
* Test action 2: Create a security group SG1, create a rule with protocol 'tcp', port_range_min and port_range_max
* **Test assertion 2:** The values returned in the response equal to the ones used to create the rule
* Test action 3: Create a security group SG1, create a rule with protocol 'icmp' and icmp_type_codes
* **Test assertion 3:** The values returned in the response equal to the ones used to create the rule
* Test action 4: Create a security group SG1, create a rule with protocol '17'
* **Test assertion 4:** The values returned in the response equal to the ones used to create the rule
* Test action 5: Create a security group SG1, create a rule with protocol 'udp', port_range_min,
...
* Test action 6: Create a security group SG1, create a rule with protocol 'tcp', port_range_min,
...
* **Test assertion 8:** There are one default security group in the list
...
* Test action 10: Create a security group SG1, create a rule with protocol 'tcp', port_range_min
  and port_range_max, and create another tcp rule with the same args
* **Test assertion 10:** Failed to create this security group rule because of duplicate protocol
* Test action 11: Create a security group SG1, create a rule with ethertype 'bad_ethertype'
* **Test assertion 11:** Failed to create this security group rule because of bad ethertype
* Test action 12: Create a security group SG1, create a rule with protocol 'bad_protocol_name'
* **Test assertion 12:** Failed to create this security group rule because of bad protocol
* Test action 13: Create a security group SG1, create a rule with remote_ip_prefix '92.168.1./24',
...
* Test action 14: Create a security group SG1, create a tcp rule with (port_range_min, port_range_max)
...
* Test action 15: Create a security group SG1, create a tcp rule with remote_group_id 'bad_group_id'
...
* Test action 16: Create a security group SG1, create a rule with a random uuid as security_group_id
...
* Security group rules can be created with different args, list, shown and deleted.
