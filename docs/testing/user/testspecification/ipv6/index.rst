...
The test suite is structured based on network, port and subnet operations. Each test case
...
Environment can be deployed on bare metal or virtualized infrastructure,
...
1. Environment can be deployed on bare metal or virtualized infrastructure,
deployment can be HA or non-HA.
