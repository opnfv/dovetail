...
* Test action 1: Create 2 networks with random name in one request, the test passes
  if the networks are found in the list after creation.
* Test action 2: Delete the 2 created networks, the test passes if the networks deleted
  are not found in the list after deleting.
* Test action 3: Create 2 networks, then create 2 IPv6 subnets on the 2 networks
  in one request, respectively, the test passes if the 2 subnets are found in the list after creation.
* Test action 4: Delete the 2 created subnets and 2 networks, the test passes if the subnets deleted,
  networks deleted are not found in the list after deleting.
* Test action 5: Create 2 networks, then create 2 ports on the 2 networks in one request, respectively,
  the test passes if the 2 ports are found in the list after creation.
* Test action 6: Delete the 2 created ports and 2 networks, the test passes if the ports deleted
  and networks deleted are not found in the list after deleting.
...
* Test action 2: Update this network with a new_name, the test passes if the network name equals
  the new_name
* Test action 3: Create an IPv6 subnet with the network
* Test action 4: Update this IPv6 subnet with a new_name, the test passes if the subnet name equals
  the new_name
* Test action 5: Delete the subnet and network, the test passes if the subnet and network are not
  found in the list after deleting.
...
* Test action 3: Verify the public network id found in the external networks, the
  test passes if the the public netwrok id is found.
...
subnets after creating a network and a IPv6 subnet, the reference is
...
* Test action 5: Delete the created subnet and network, the test passes if
  the subnet and network are not found in the list.
...
* Test action 5: Delete the subnet and network, the test passes if the subnet and
  network are not found in the list.
...
There should be a IPv6 CIDR configuration, which prefixlen is less than 126.
...
* Test action 4: Create an IPv6 subnet of the the network within the allocation pools.
* Test action 5: Create a port of the network, the test passes if the port's id
  is in the range of the allocation pools.
* Test action 6: Delete the created port, subnet and network, the test passes if the port,
  subnet and network are not found in the list after deleting.
...
* Test action 4: Delete the created port, subnet and network, the test passes
  if the port, subnet and network are not found in the list after deleting.
...
* Test action 4: Delete the port and network, the test passes
  if the port and network are not found in the list after deleting.
...
* Test action 4: Delete the port and network, the test passes if the port
  and network are not found in the list after deleting.
...
* Test action 5: Delete the port and network, the test passes if the port and network
  are not found in the list after deleting.
...
* Test action 6: Delete the networks, subnets, router and interfaces, the test passes if they
  are not found in the list after deleting.
...
* Test action 8: Delete the network, subnet, router and port, the test passes if
  they are not found in the list after deleting.
...
This test case evaluates OpenStack API's abilities of adding and removing a router interface with
...
* Test action 8: Delete the network, subnet and router, the test passes if they
  are not found in the list after deleting
...
This test case evaluates OpenStack API's abilities of creating, showing, listing, updating
...
* Test action 8: Delete the router, the test passes if the router is
...
This test case evaluates OpenStack API's abilities of creating, listing, updating, showing
...
* Test action 6: Delete the security group, the test passes if it is
  not found in the list after deleting
...
This test case evaluates OpenStack API's abilities of creating, showing, listing and deleting
...
* Test action 1: Create a security group
* Test action 2: Create a rule of the security group with protocol tcp
...
* Test action 4: List rules, the test passes if the created rule is in
  the listed rules.
* Test action 5: Delete the security group and security group rules, the test passes if
  they are not found in the list after deleting.
...
This test case evaluates OpenStack API's abilities of listing security groups, the reference is
...
* Test action 10: Delete the network and VMs, the test passes if the VMs and the network
  are not found in the list after deleting.
...
* Test action 11: Delete the network and VMs, the test passes if the VMs and the network
  are not found in the list after deleting.
