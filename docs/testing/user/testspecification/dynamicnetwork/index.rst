...
The tests in this test area will evaluate network runtime operations
...
* **Test assertion 3:** retrieve the VM1's configured dns and verify it has
...
* Updating subnet's DNS server configurations are effecting the VMs.
