...
networking_bgpvpn_tempest.tests.api.test_show_bgpvpn_as_non_owner_fail
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
* Create a BGPVPN vpn1 as tenant2.
...
networking_bgpvpn_tempest.tests.api.test_list_bgpvpn_as_non_owner_fail
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
* Create a BGPVPN vpn1 as tenant1.
* Retrieve a list of all BGPVPNs as tenant2.
* **Test assertion**: The list of BGPVPNs retieved by tenant2 does not include
  vpn1.


networking_bgpvpn_tempest.tests.api.test_show_netassoc_as_non_owner_fail
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
* Create BGPVPN vpn1 as tenant1.
* Associate vpn1 with a Neutron network as tenant1
...
* Create BGPVPN vpn1 as tenant1.
* Associate vpn1 with a Neutron network as tenant1.
* Retrieve a list of all network associations as tenant2.
* **Test assertion**: The retrieved list of network associations does not
  include the network association created in step 2.
...
networking_bgpvpn_tempest.tests.api.test_update_route_target
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
* Create a BGPVPN vpn1 with specific route targets.
* Update vpn1 with different route targets.
* Retrieve the metadata of vpn1.
* **Test assertion**: The metadata of vpn1 includes the updated route targets.
...
networking_bgpvpn_tempest.tests.api.test_create_bgpvpn_with_invalid_routetargets
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
* Attempt to create a BGPVPN with invalid route targets.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
* Create BGPVPN vpn1.
* Associate vpn1 with a Neutron network.
* Attempt to delete the network association with an invalid network UUID.
* **Test assertion**: The deletion of the network association fails.
