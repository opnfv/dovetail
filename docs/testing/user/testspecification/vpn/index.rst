...
All VMs, networks, subnets and VPNs created during the test have been deleted.
...
* **Test assertion 2:** Ping the floating IP of VM1 from the host running the test framework
