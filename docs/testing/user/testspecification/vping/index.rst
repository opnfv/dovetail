...
requires L3 connectivity between those VMs. Target IP is passed to the VM
...
* **Test assertion 7:** SSH connection between host or jumphost and VM2 is established within 300 seconds
