...
* Test action 6: inside VM2, the ping script is executed automatically when boot and it contains a infinite
  loop doing the ping, monitoring the console-log of VM2 to see the response generated by the script.
* **Test assertion 5:** the return code is 0, which means ping OK, when monitoring the console-log in VM2
...
* **Test assertion 8:** the return code is 0, which means ping OK, after executing Ping script in VM2
