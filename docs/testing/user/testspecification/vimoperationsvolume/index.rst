...
test case 5, and test cases 14 and 15 are the alias of thet cases 6 and 7, respectivy.
Alias should always be included so that the test run will be tempest version agnostic,
which can be used to test different version of OpenStack.
...
* Get a volume with an invalid/an empty/a nonexistent volume volume ID is not allowed.
...
* **Test assertion 8:** Verify the metadata parameter of the fetched volume are correct
