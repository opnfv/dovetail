...
.. code-block:: bash
   ...
   # Authentication username, belongs to the project above, admin project is recommended.
...
.. code-block:: bash
   ...
   -
       ...
       # User name of the default user of this node. This user **must** have sudo privileges.
       user: root
