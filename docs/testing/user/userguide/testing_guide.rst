...
we will also create a home directory for storing all Dovetail related config files:
...
.. code-block:: bash
   ...
   $ sudo docker pull opnfv/dovetail:cvp.0.1.0
   cvp.0.1.0: Pulling from opnfv/dovetail
   ...
   Status: Downloaded newer image for opnfv/dovetail:cvp.0.1.0

An example of the <tag> is *cvp.0.1.0*.
...
.. code-block:: bash
   ...
   $ sudo docker pull opnfv/dovetail:cvp.0.1.0
   $ sudo docker pull opnfv/functest:danube.2.0
   $ sudo docker pull opnfv/yardstick:danube.2.0
...
.. code-block:: bash
   ...
   $ sudo docker save -o dovetail.tar opnfv/dovetail:cvp.0.1.0 opnfv/functest:danube.2.0 opnfv/yardstick:danube.2.0
...
.. code-block:: bash
   ...
   opnfv/functest      danube.2.0          9eaeaea5f203        8 days ago          1.53GB
   opnfv/dovetail      cvp.0.1.0           5d25b289451c        8 days ago          516MB
   opnfv/yardstick     danube.2.0          574596b6ea12        8 days ago          1.2GB
