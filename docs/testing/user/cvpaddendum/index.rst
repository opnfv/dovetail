...
wide adoption but are seen as significant requirements in NFV,
...
The OPNFV testing projects Bottlenecks and Yardstick have started testing
OPNFV system resiliency with load in
the Danube release that can be used to provide limited coverage in this area.
This is a relatively new test methodology in OPNFV, we will incorporate it as
optional for Danube.
