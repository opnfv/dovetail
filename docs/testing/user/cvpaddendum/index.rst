...
wide adoption but are seen as significant requirements in NFV, or
an industry consensus about APIs and behaviors is still deemed beneficial. In such
...
in a compliant way that enables this basic VNF to run on any OPNFV certified
systems.
...
services. Running such basic VNF leads to a set of common requirements, including:
  - VNF image management (Refstack testing Glance API)
...
a common standard to enable portability across OPNFV certified platforms.
...
may impose new API demands, maturity and industry adoption must be prerequisite for
...
part of the basic cloud capabilities that are verified in CVP.
