...
Based on the "designspecification" document, the VIM operations test suite includes <the number> specific test cases.
For each test case and its containing test items, please refer to the document named "vimops.<>.specification".
The test procedure for each test case is shown as below.
